...
方向键(↓)： VK_DOWN (40)
*/
#define KEYCODE_VK_LEFT  0x37
#define KEYCODE_VK_UP    0x1b
#define KEYCODE_VK_RIGHT 0x39
#define KEYCODE_VK_DOWN  0x40
    ...
    {  
        ...
        {  
            ...
            case KEYCODE_A: {
                ...
                cmdvel.linear.x = speed_x * max_tv;  
                cmdvel.linear.y = speed_y * max_tv;  
                cmdvel.angular.z = 0.6; 
